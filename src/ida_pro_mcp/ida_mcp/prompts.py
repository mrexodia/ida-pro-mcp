...
def probe_workflow() -> str:
    ...
    return (
        ...
        "already launched (F9). Connect with ?ext=dbg,probes.\n"
        "\n"
...
def crypto_hunt() -> str:
    ...
    return (
        ...
        "4. CONFIRM LIVE. With ?ext=dbg,probes, probe_net(recv_ea, decrypt_ea)\n"
...
def opcode_map() -> str:
    ...
    return (
        ...
        "3. CONFIRM LIVE. With ?ext=dbg,probes, probe the dispatch site and\n"
